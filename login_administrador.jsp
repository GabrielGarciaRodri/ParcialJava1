    ...
    <div class="container mt-5">
        ...
        <% 
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * FROM administrador WHERE correo_electronico = ? AND contrasena = ?");
        ...
        %>
        <form action="login_administrador.jsp" method="post">
        ...
        <div class="text-center my-3">
            ...
            <a href="registro_administrador.jsp" class="btn btn-info btn-block">Crear una cuenta</a>
        </div>
